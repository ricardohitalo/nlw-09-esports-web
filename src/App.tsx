...
function App() {
  return (
    <div className="max-w-[1344px] flex flex-col mx-auto items-center my-20">
      <img className="w-80" src={logoImg} alt="Logo-eSports" />
      ...
      <div className="pt-1 mt-8 bg-nlw-gradient self-stretch rounded-lg overflow-hidden">
        <div className="bg-[#2a3624] px-8 py-6 flex justify-between items-center">
          <div>
            <strong className="text-2xl text-white font-black block">Não encontrou seu duo?</strong>
            <span className="text-zinc-400 block">Publique um anúncio para encontrar novos Playes!</span>
          </div>
